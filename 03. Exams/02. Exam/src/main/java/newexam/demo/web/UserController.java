...
import newexam.demo.model.binding.UserLoginBindingModel;
import newexam.demo.model.binding.UserRegisterBindingModel;
...
public class UserController {
    ...
    public String loginConfirm(@Valid @ModelAttribute("userLoginBindingModel") UserLoginBindingModel userLoginBindingModel,
        ...
        UserServiceModel userServiceModel=this.userService.findByEmail(userLoginBindingModel.getEmail());
